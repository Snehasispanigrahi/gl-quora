...
//enables web security and allows the configuration class to either implement the WebSecurityConfigurer interface or
//extend the class WebSecurityConfigurerAdapter. The latter class does implement the former interface.
@EnableWebSecurity
